...
use App\Http\Controllers\Users\ViewStudentProfileController;
...
Route::middleware(['auth', 'isadmin'])->group(function () {
    ...
    Route::post('/change_session', [SessionController::class, 'changeSession'])->name('change_session');
...
Route::middleware(['auth', 'isteacher', 'issubjectteacher'])->group(function () {
...
Route::post('/student_profile/{student}', [ViewStudentProfileController::class, 'show'])->name('view_student_profile');

Route::post('/result/{student}/{session}/{term}', [ViewResultController::class, 'show'])->name('view_result');
Route::post('/convert_to_pdf/{student}/{session}/{term}', [ViewResultController::class, 'pdfConvert'])->name('convert_to_pdf');
Route::post('/convert_to_excel/{student}/{session}/{term}', [ViewResultController::class, 'excelConvert'])->name('convert_to_excel');
